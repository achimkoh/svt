...
function draw() { 
  ...
  sphere(10);
  pop();
  rotateY(millis()/1000); // how to translate 3d rotation into actual value?
  if (mouseIsPressed) testpoints.push(createVector(mouseX-width/2, mouseY-height/2, 0));
  ...
  //       vertex(testpoints[i].x,testpoints[i].y,testpoints[i].z);
  //     }
  //   endShape();
  // }
